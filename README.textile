h2. jquery-daterange-picker

A small and simple utility built on top of "jQuery UI's datepicker":http://docs.jquery.com/UI/Datepicker that provides
...
Check examples in the demo directory
